        ...
        <div class="col-12">
            ...
            <div class="single_blog_content p-4 shadow-sm bg-light">
                    ...
                    <div class="card mb-3 shadow border-0">
                        <div class="card-body">
                            <a href="#">  
                            <h5 class="card-title text-primary fw-bold">URGENT: SUSTAINABILITY CONSULTANT</h5>
                            </a>
                    ...
                    <div class="card mb-3 shadow border-0">
                        <div class="card-body">
                            <a href="#">  
                            <h5 class="card-title text-primary fw-bold">URGENT: CARBON FOOTPRINT ANALYST</h5>
                            </a>
                    ...
                    <div class="card mb-3 shadow border-0">
                        <div class="card-body">
                            <a href="#">  
                            <h5 class="card-title text-primary fw-bold">URGENT: CIRCULAR ECONOMY ADVISOR</h5>
                            </a>
