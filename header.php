...
<body>
	...
	<!--==================================================-->
	<!-- Start NEXUS Header Top Menu Area Css -->
	<!--==================================================-->
				...
				<div class="col-lg-9 col-sm-8">
					<div class="header_top_menu_address">
						<div class="header_top_menu_address_inner">
							<ul>
								<li><a href="#"><i class="fa fa-envelope-o"></i>g.gozalo@nexusbuildandconsultants.com</a></li>
								<li><a href="#"><i class="fa fa-map-marker"></i>30 N Gould St. Site N, Sheridan, WY 82801</a></li>
								<li><a href="#"><i class="fa fa-phone"></i>(PH) +63 9352314443 </a></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<!--==================================================-->
	<!-- End NEXUS Header Top Menu Area Css -->
	<!--===================================================-->